...
class Jet_Search_Ajax_Search_Widget extends Jet_Search_Widget_Base {
	...
	protected function register_controls() {
		...
		function get_categories_by_tax_name($tax_name){
		...
		$this->add_control(
			...
			array(
				...
				'default' => esc_html__( 'Find Your Course', 'jet-search' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Show Categories', 'jet-search' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'separator' => 'before',
			)
		...
		$this->add_control(
			'category_list',
			array(
				'label'     => esc_html__( 'Categories', 'jet-search' ),
				'type'      => Controls_Manager::SELECT2,
				'multiple'	=> true,
				'default'   => 'category',
				'options'   => get_categories_by_tax_name('course-category'),
				'condition' => array(
		...
		$this->add_control(
			'search_category_shape_icon_size',
			array(
				'label'      => esc_html__( 'Arrow Shap Size', 'jet-search' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', 'rem' ),
				'range' => array(
					'px' => array(
				...
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['categories'] . ' svg.shape' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		$this->add_control(
			'search_category_shape_icon_color',
			array(
				'label' => esc_html__( 'Arrow Shap Color', 'jet-search' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['categories'] . ' svg.shape path' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} ' . $css_scheme['categories_select_icon'] . ' i' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .jet-ajax-search__categories-select-icon svg path' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->start_controls_section(
			'section_tag_style',
			array(
				'label' => esc_html__( 'Tag Style', 'jet-search' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_search_category_list' => [ 'yes' ],
				],
		 ...
		 $this->add_responsive_control(
			'tag_item_margin',
			[
				'label' => esc_html__( 'Item Margin', 'jet-search' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		 $this->start_controls_tabs(
			...
			$this->add_control(
				...
				array(
					...
					'type'  => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_control(
				...
				array(
					...
					'type'  => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a' => 'background: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
				...
				[
					'name' => 'tag_typography',
					'selector' => '{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a',
				]
			);
			$this->add_group_control(
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
					'selectors' => [
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
					'selectors' => [
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
					'selectors' => [
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				array(
					...
					'type'  => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a:hover' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_control(
				...
				array(
					...
					'type'  => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a:hover' => 'background: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper a:hover',
				]
			);
			...
			$this->add_control(
				'tag_style_align',
				array(
					'label'   => esc_html__( 'Tag ALign', 'jet-search' ),
					'type'    => Controls_Manager::CHOOSE,
					'options' => array(
						'flex-start' => array(
							'title' => esc_html__( 'Flex Left', 'jet-search' ),
						...
						'flex-end' => array(
							'title' => esc_html__( 'Flex End', 'jet-search' ),
							'icon'  => 'eicon-flex eicon-align-end-v',
						),
						'space-between' => array(
							'title' => esc_html__( 'Space Between', 'jet-search' ),
							'icon'  => 'eicon-flex eicon-align-stretch-v',
						),
					),
					'selectors' => array(
						'{{WRAPPER}} .jet-ajax-search .banner-tags-wrapper' => 'justify-content: {{VALUE}};',
					),
				)
			);
