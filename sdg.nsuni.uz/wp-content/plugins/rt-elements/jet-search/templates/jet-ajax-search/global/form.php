...
$is_product_type  = 0;
$show_cat_item = !empty($settings['show_search_category_list']) ? $settings['show_search_category_list'] : '';
...
<form class="jet-ajax-search__form rt-jet-form" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search" target="<?php echo $link_target_attr; ?>">
...
<!-- Cat Btn Style  -->
<?php 
if($show_cat_item == 'yes'): ?>
	<div class="banner-tags-wrapper">      
		<!-- single tags wrapper -->
		<?php echo $this->get_categories_list2(); ?>
