...
class Rts_HFE_Settings_Page {
	...
	public function __construct() {
		...
		add_filter( 'views_edit-rts-elementor-hf', [ $this, 'hfe_settings' ], 10, 1 );
		add_filter( 'admin_footer_text', [ $this, 'admin_footer_text' ] );
		add_action( 'admin_enqueue_scripts', [ $this, 'enqueue_admin_scripts' ] );
		add_filter( 'plugin_action_links_' . Rts_HFE_PATH, [ $this, 'settings_link' ] );
	}
	...
	public function admin_footer_text( $footer_text ) {
		...
		$is_elementor_screen = ( $current_screen && ( 'rts-elementor-hf' === $current_screen->post_type || 'appearance_page_hfe-guide' === $current_screen->id || 'appearance_page_hfe-about' === $current_screen->id || 'appearance_page_hfe-settings' === $current_screen->id ) );
	...
	public function get_guide_modal() {
		$new_page_url = admin_url( 'post-new.php?post_type=rts-elementor-hf' );
		?>
		<div class="hfe-guide-modal-popup" data-new-page="<?php echo esc_attr( $new_page_url ); ?>">
			<div class="hfe-guide-modal-popup-wrapper">
				<div class="hfe-guide-modal-content">
					<div class="heading">
						<img src="<?php echo Rts_HFE_URL . 'assets/images/header-footer-elementor-icon.svg'; ?>" class="hfe-logo">
	...
	protected function output_about_info() {
		...
		<div class="hfe-admin-about-section hfe-admin-columns hfe-admin-about-us">
			...
			<div class="hfe-admin-column-40 hfe-admin-column-last">
				<figure>
					<img src="<?php echo Rts_HFE_URL; ?>assets/images/settings/our-team.jpeg" alt="<?php esc_attr_e( 'Team photo', 'header-footer-elementor' ); ?>">
					<figcaption>
	...
	protected function get_bsf_plugins() {
		...
		$images_url = Rts_HFE_URL . 'assets/images/settings/';
