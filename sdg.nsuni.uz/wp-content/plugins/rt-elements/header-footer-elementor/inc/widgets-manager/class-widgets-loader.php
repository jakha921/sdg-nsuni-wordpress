...
namespace Rts_HFE\WidgetsManager;
 ...
 */
class Rts_Widgets_Loader {

	/**
	 * Instance of Rts_Widgets_Loader.
	 *
	 * @since  1.2.0
	 * @var null
	 */
	...
	/**
	 * Get instance of Rts_Widgets_Loader
	 *
	 * @since  1.2.0
	 * @return Rts_Widgets_Loader
	 */
	...
	public function include_widgets_files() {
		...
		if ( ! empty( $widget_list ) ) {
			foreach ( $widget_list as $handle => $data ) {
				require_once Rts_HFE_DIR . '/inc/widgets-manager/widgets/class-' . $data . '.php';
			}
		}

		// if ( ! empty( $js_files ) ) {
		// 	foreach ( $js_files as $handle => $data ) {
		// 		wp_register_script( $handle, Rts_HFE_URL . $data['path'], $data['dep'], Rts_HFE_VER, $data['in_footer'] );
		// 	}
		// }
		...
		//wp_enqueue_style( 'hfe-widgets-style', Rts_HFE_URL . 'inc/widgets-css/frontend.css', [], Rts_HFE_VER );
	}
	...
	public function register_widgets() {
		...
		Plugin::instance()->widgets_manager->register( new Widgets\Rts__Navigation_Menu() );
