...
use Rts_HFE\WidgetsManager\Rts_Widgets_Loader;
...
class Page_Title extends Widget_Base {
	...
	protected function render() {
		...
		$heading_size_tag = Rts_Widgets_Loader::validate_html_tag( $settings['heading_tag'] );
		?>		
		...
		?>
			...
			<<?php echo $heading_size_tag; ?> class="elementor-heading-title elementor-size-<?php echo $settings['size']; ?>">
				...
				if(is_home() && !is_front_page() || is_home() && is_front_page()){
					$builo_option = get_option( 'builo_option' );
					if(!empty($builo_option['Rts_blog__title'])){
						echo esc_html($builo_option['Rts_blog__title']);
					}
				...
				elseif(is_singular( 'post' )){
					$builo_option = get_option( 'builo_option' );
					if(!empty($builo_option['Rts_blog_single__title'])){
						echo esc_html($builo_option['Rts_blog_single__title']);
					}
