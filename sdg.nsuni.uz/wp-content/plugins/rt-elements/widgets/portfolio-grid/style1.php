...
if ( is_plugin_active('the-events-calendar/the-events-calendar.php') ) { 
    foreach ( $events as $event ) {
        ...
        <div class="col-lg-<?php echo esc_html($settings['portfolio_columns']); ?> col-md-6 col-xs-1 grid-item <?php echo esc_attr($termsString); ?>">
            <div class="rts__single--event event_item">
                ...
                <div class="rts__single--event--meta">
                    ...
                    <h5 class="rts__single--event--meta--title event-title">
                        <?php 
                    ...
                    <a aria-label="event button" href="<?php echo get_permalink($event->ID); ?>" class="rts__round--btn">
