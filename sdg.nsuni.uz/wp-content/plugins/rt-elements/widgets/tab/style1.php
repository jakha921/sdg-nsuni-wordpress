<div class="rts-tab-style-one <?php echo $settings['type'];?>">
    <div class="align-items-start contoler-company">
        <div class="nav nav-pills me-3 button-area" id="v-pills-tab" role="tablist" aria-orientation="<?php echo $settings['type'];?>">
            <?php
