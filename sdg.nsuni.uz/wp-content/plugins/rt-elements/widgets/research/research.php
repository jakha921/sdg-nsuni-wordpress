...
class Reactheme_Research_Grid_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'RT Research Grid', 'rtelements' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
                ...
                'condition' => ['research_grid_style' => ['1']],
			]
		); 
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .research-item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .research-inner-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .grid-research .row' => '--bs-gutter-x: {{SIZE}}{{UNIT}} !important;',
                ],
			]
		);    			
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rts__research--single--meta--title' => 'color: {{VALUE}};',                   
                ],                
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rts__research--single--meta--title:hover' => 'color: {{VALUE}};',                                      
                ],                
            ]            
        );
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rts__research--single--meta--title',                    
			]
		);		
		$this->add_responsive_control(
			'title_padding',
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .rts__research--single--meta--title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .rts__research--single--meta--title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rts__research--single--meta--excerpt' => 'color: {{VALUE}};',                   
                ],                
            ]
        );
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rts__research--single--meta--excerpt',                    
			]
		);		
		$this->add_responsive_control(
			'des_padding',
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .rts__research--single--meta--excerpt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .rts__research--single--meta--excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Image Border Radius', 'rtelements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
					'px' => [
                ...
                'selectors' => [
					'{{WRAPPER}} .rts__research--single--thumb' => 'border-radius: {{SIZE}}{{UNIT}};',                
				],                  
            ]
        ); 
        $this->end_controls_section();
	...
	<div class="rt-research-style<?php echo esc_attr($settings['research_grid_style']); ?> grid-research <?php echo esc_attr($team_link); ?>">
		<div class="grid">
			<div class="row">
			<?php 
				if('1' == $settings['research_grid_style']){
					require_once plugin_dir_path(__FILE__)."/style1.php";
				}
				if('2' == $settings['research_grid_style']){
					require_once plugin_dir_path(__FILE__)."/style2.php";
				}
				if('3' == $settings['research_grid_style']){
...
public function getCategories(){
    $cat_list = [];
     	if ( post_type_exists( 'rt-research' ) ) { 
