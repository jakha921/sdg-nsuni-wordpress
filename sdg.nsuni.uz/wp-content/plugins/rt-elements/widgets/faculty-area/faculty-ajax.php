<?php
add_action( 'wp_ajax_getFacultySearchResult', 'getFacultySearchResult' );
add_action( 'wp_ajax_nopriv_getFacultySearchResult', 'getFacultySearchResult' );
function getFacultySearchResult(){
