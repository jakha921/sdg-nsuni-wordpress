...
class RTS_Site_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'RT Site Logo', 'rtelements' );
	}
	...
	protected function render() {
		...
		<?php if ( $link ) : ?>
					...
					?>
				<a aria-label="logo" data-elementor-open-lightbox="<?php echo esc_attr( $settings['open_lightbox'] ); ?>"  class='<?php echo  esc_attr( $class ); ?>' <?php echo $this->get_render_attribute_string( 'link' ); ?>>
		<?php endif; ?>
		<?php
		if ( empty( $site_image ) ) {
			return;
			...
			<div class="hfe-site-logo-set">           
				<div class="hfe-site-logo-container">
					<?php if(!empty($image_url)): ?>
						<img class="hfe-site-logo-img <?php echo esc_attr( $hide_desktop_logo ); ?>"  src="<?php echo esc_url( $image_url ); ?>" width="160" height="55" alt="<?php echo esc_attr( Control_Media::get_image_alt( $settings['custom_image'] ) ); ?>"/>
					<?php endif; ?>
					<?php if(!empty($image_url2)): ?>
						<img class="hfe-site-sticky-logo-img"  src="<?php echo esc_url( $image_url2 ); ?>" width="160" height="55" alt="<?php echo esc_attr( Control_Media::get_image_alt( $settings['custom_image_sticky'] ) ); ?>"/>
				<?php endif; ?>
				</div>
			</div>
		<?php if ( $link ) : ?>
